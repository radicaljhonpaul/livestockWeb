...
class TopHealthIssuesInterventionsExport implements FromCollection, WithHeadings, WithTitle
{
    use Exportable;

    private $sheetTitle = "Interventions Report";
    ...
    public function collection()
    {
        ...
        ->where('interventions.need_license', 0)
