...
class TopHealthIssuesHealthConditionExport implements FromCollection, WithHeadings, WithTitle
{
    use Exportable;

    private $sheetTitle = "Health Conditions Report";
    ...
    {
        return DiagnosisLogHealthCondition::join('health_conditions', 'diagnosis_log_health_conditions.health_condition_id', '=', 'health_conditions.id')
        ->join('diagnosis_logs', 'diagnosis_log_health_conditions.diagnosis_log_id', '=', 'diagnosis_logs.id')
        ...
        ->select(
            ...
            'health_conditions.name AS hc_name',
